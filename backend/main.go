...
func main() {
	...
	r.POST("/api/reset-password", controllers.ResetPW)
	...
	r.GET("/api/tugas/user", controllers.GetTugasByUser) // New Endpoint
	...
	// NOTIFICATION ROUTES
	// -------------------------
	r.GET("/api/notifications", controllers.GetUserNotifications)
