...
<div class="p-8 bg-gray-50 min-h-screen">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        {{-- Deadline Terdekat --}}
        <div class="bg-cyan-400 rounded-xl p-6 text-white shadow-lg">
            <h2 class="text-lg font-semibold mb-4 flex items-center gap-2">
                <span>‼️</span> Tugas Deadline Terdekat
            </h2>

            <div class="space-y-4">
                <div>
                    <p class="font-semibold">Tinjau SOP Baru</p>
                    <p class="text-sm">Batas Waktu: 2024-07-22</p>
                    <p class="text-xs opacity-90">Dari: Bpk. Budi</p>
                </div>

                <div>
                    <p class="font-semibold">Evaluasi Kinerja Tim</p>
                    <p class="text-sm">Batas Waktu: 2024-07-25</p>
                    <p class="text-xs opacity-90">Dari: Bpk. Budi</p>
                </div>
            </div>
        </div>
